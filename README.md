...
OBS: Quanto mais especifico for o seu prompt melhor será o resultado que a inteligência artificial irá te devolver. Tente sempre aplicar as tecnicas de engenharia de prompt para ter resutados cada vez melhores.

Boa tarde Copilot, Através desse PRD (Product Requirements Document) quero criar um aplicativo através de vibe coding utilizando o LOVABLE.DEV
...
6. Possuir uma tela de gráficos onde o usuário possa controlar onde estão os seus gastos, as suas entradas e as suas economias
